                    ...
                    <div class="content-box-large">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" id="blog_frm" method="post">
                                ...
                                <input type="text" class="form-control" id="news_title" required="required" name="news_title">
                                <br>

                                <label >News Image</label>

                                <input type="file" class="btn btn-default" id="news_image" required="required" name="news_image">
                                <br>
                                <div class="checkbox">
                                    <label> <input type="checkbox" name="news_vis" id="news_vis" > Visible
                                    </label>
                                </div>
                                <br>
                                <textarea id="tinymce_full" name="content_news"></textarea>
                                <br>
