...
class News_class  {
    ...
    public function newsUpload($data, $image) {
        try {
            ...
            $target_dir = "images/";
            $target_file = $_SERVER["DOCUMENT_ROOT"].'/myproject_smotik/web-admin/admin/'.$target_dir . basename($image ["image"] ["name"]);
            ...
            $date_news = date('d-m-Y', strtotime('now'));
                ...
                VALUES ('$title','$target_file_1','$content','$isvisible','$date_news')";
