...
<html lang="en">
    ...
    <body>
        ...
        <div class="container srv">
            <div class="row">
                <h2 class="page-header chdg">Music Zoning </h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active"><img class="img-responsive" src="img/img3.jpg" alt=""></div>
                                <div class="item"><img class="img-responsive" src="img/img3.jpg" alt=""></div>
                                <div class="item"><img class="img-responsive" src="img/img3.jpg" alt=""></div>
                            </div>
                    ...
                    <div class="col-md-4 abt-txt">
                        <h3>Lorem ipsum dolor sit amet</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, justo eu convallis placerat, felis enim.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 col-xs-6">
                        <a href="#"><img class="img-responsive img-hover img-related" src="img/img3.jpg" alt=""></a>
                    </div>
